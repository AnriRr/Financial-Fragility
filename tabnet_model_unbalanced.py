...
OUT_DIR = "tabnet_results_unbalanced"
...
def objective_tabnet(trial, X_train, y_train, cv_inner):
...
# Mean metrics
results_df.to_csv(os.path.join(OUT_DIR, "tabnet_results_unbalanced.csv"), index=True)
